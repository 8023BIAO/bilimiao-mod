...
private class UserSeasonDetailViewModel(
    ...
    fun setCurrentSection(section: bilibili.app.view.v1.Section) {
        ...
        list.data.value = applySort(section.episodes, sortMode.value)
    }

    fun changeSortMode(mode: SeasonSortMode) {
        sortMode.value = mode
        val section = curSection.value ?: return
        list.data.value = applySort(section.episodes, mode)
    }
